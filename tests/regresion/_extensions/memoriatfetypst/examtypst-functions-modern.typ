...
// ============================================
// EJERCICIO — estilo tarjeta con barra lateral
// ============================================
#let ejercicio(title: none, puntos: none, body) = {
  ...
  context {
    ...
    grid(
      ...
      column-gutter: 0pt,
      row-gutter: 0pt,
      block(fill: accent-ej, width: 100%, height: 100%),
      block(
        fill: theme-bg, inset: (x: 12pt, y: 8pt), above: 0.5em, below: 0.5em,
        width: 100%,
        [ #header  #v(0.3em)  #text(fill: theme-text, size: 0.95em)[#body] ]
      )
    )
  }
}
...
// ============================================
// SOLUCIÓN — tarjeta verde con barra lateral
// ============================================
#let solucion(body) = {
  grid(
    columns: (4pt, 1fr),
    column-gutter: 0pt,
    block(fill: accent-sol, width: 100%),
    block(
      fill: theme-sol-bg, inset: (x: 12pt, y: 6pt),
      above: 0.5em, below: 0.5em, width: 100%,
