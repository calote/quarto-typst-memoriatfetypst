...
format:
  memoriatfetypst-typst: 
    ...
    #syntax-highlighting: arrow  # arrow, solarized, monokai, gruvbox, github 
    # No recomendados (código en línea se ve mal): dracula, nord
    #keep-typ: true
    tofiguras: true
    totablas: true
    papersize: a4
    ...
    #theorem-appearance: rainbow    # simple (default), fancy, clouds, rainbow
    link-color: "#2563eb" 
    internal-link-color: "059669" # "059669" (verde)   "#dc2626" (rojo)
    cite-color: "#7c3aed"  # "#7c3aed" (púrpura)   #5b5b9e"  
    # Ahora deberías ver:
    # 
    # Enlaces externos (URLs) → azul #2563eb
    # Referencias cruzadas (@thm-xxx, @fig-xxx, @sec-xxx) → verde #059669
    # Citas (@cite2020) → púrpura #7c3aed    
    # margin: 
    #   x: 2cm 
    #   y: 2cm
    toccapitulos: false
...
::: {#exr-ejercicio-2} 
Calcula la mediana y la cuasivarianza de la variable aleatoria que representa el lanzamiento de un dado justo de seis caras.
:::
